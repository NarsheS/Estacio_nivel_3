...
import ControleEditora from "./ControleEditora.ts";
...
let livros: Array<Livro> = [
  ...
  new Livro(3, editoras[2].codEditora, "Narcisismo", "Como saber se você é Narcisista", ["Isabela Bitëncourt", "Enzo Schëwinzteiger"])
]
